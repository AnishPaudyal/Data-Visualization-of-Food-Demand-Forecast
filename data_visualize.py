...
st.title('Data Visualization of Food Demand Forecasting Dataset')

@st.cache
def load_data(nrows):
    data = pd.read_csv('weekly_demand_data.csv', nrows=nrows)
    return data
...
hist_data = [weekly_data['checkout_price'], weekly_data['base_price'], weekly_data['num_orders']]
